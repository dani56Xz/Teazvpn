...
UPDATE subscriptions SET start_date = COALESCE(start_date, CURRENT_TIMESTAMP),
                        duration_days = CASE
                            WHEN plan = '🥉۱ ماهه | ۱۸۰ هزار تومان | نامحدود | ۲ کاربره' THEN 30
                            WHEN plan = '🥈۳ ماهه | ۵۴۰ هزار تومان | نامحدود | ۲ کاربره' THEN 90
                            WHEN plan = '🥇۶ ماهه | ۷۲۰ هزار تومان | نامحدود | ۲ کاربره' THEN 180
                            WHEN plan = '🥉۱ ماهه | ۱۴۰ هزار تومان | نامحدود | ۲ کاربره' THEN 30
                            WHEN plan = '🥈۳ ماهه | ۴۳۰ هزار تومان | نامحدود | ۲ کاربره' THEN 90
                            WHEN plan = '🥇۶ ماهه | ۵۷۰ هزار تومان | نامحدود | ۲ کاربره' THEN 180
                            ELSE 30
                        END
...
def get_subscription_keyboard(is_agent=False):
    if is_agent:
        keyboard = [
            ...
            [KeyboardButton("🥈۳ ماهه | ۴۳۰ هزار تومان | نامحدود | ۲ کاربره")],
            [KeyboardButton("🥇۶ ماهه | ۵۷۰ هزار تومان | نامحدود | ۲ کاربره")],
            [KeyboardButton("⬅️ بازگشت به منو")]
        ]
    else:
        keyboard = [
            [KeyboardButton("🥉۱ ماهه | ۱۸۰ هزار تومان | نامحدود | ۲ کاربره")],
            [KeyboardButton("🥈۳ ماهه | ۵۴۰ هزار تومان | نامحدود | ۲ کاربره")],
            [KeyboardButton("🥇۶ ماهه | ۷۲۰ هزار تومان | نامحدود | ۲ کاربره")],
            [KeyboardButton("⬅️ بازگشت به منو")]
        ]
    return ReplyKeyboardMarkup(keyboard, resize_keyboard=True)
...
async def add_subscription(user_id, payment_id, plan):
    try:
        duration_mapping = {
            ...
            "🥈۳ ماهه | ۴۳۰ هزار تومان | نامحدود | ۲ کاربره": 90,
            "🥇۶ ماهه | ۵۷۰ هزار تومان | نامحدود | ۲ کاربره": 180
        }
...
async def handle_normal_commands(update, context, user_id, text):
    ...
    if text in [
        ...
        mapping = {
            "🥉۱ ماهه | ۱۸۰ هزار تومان | نامحدود | ۲ کاربره": 180000,
            "🥈۳ ماهه | ۵۴۰ هزار تومان | نامحدود | ۲ کاربره": 540000,
            "🥇۶ ماهه | ۷۲۰ هزار تومان | نامحدود | ۲ کاربره": 720000,
            "🥉۱ ماهه | ۱۴۰ هزار تومان | نامحدود | ۲ کاربره": 140000,
            "🥈۳ ماهه | ۴۳۰ هزار تومان | نامحدود | ۲ کاربره": 430000,
            "🥇۶ ماهه | ۵۷۰ هزار تومان | نامحدود | ۲ کاربره": 570000
        }
    ...
    if text == "💵 اعتبار رایگان":
        ...
        try:
            await context.bot.send_message(
                chat_id=user_id,
                text=f"💵 لینک اختصاصی شما برای دعوت دوستان:\n{invite_link}\n\n"
                     "برای هر دعوت موفق، ۱۰,۰۰۰ تومان به موجودی شما اضافه خواهد شد.",
                reply_markup=get_main_keyboard()
            )
        except Exception as e:
            logging.error(f"Error sending invite message: {e}")
            await update.message.reply_text(
        ...
        try:
            await application.bot.send_message(
                ...
                text="🤖 ربات تیز VPN با موفقیت راه‌اندازی شد!\n"
                     ...
                     "4️⃣ به‌روزرسانی قیمت‌ها:\n"
                     "   • کاربران ساده: ۱ ماهه ۱۸۰ هزار، ۳ ماهه ۵۴۰ هزار، ۶ ماهه ۷۲۰ هزار\n"
                     "   • نمایندگان: ۱ ماهه ۱۴۰ هزار، ۳ ماهه ۴۳۰ هزار، ۶ ماهه ۵۷۰ هزار"
            )
        except Exception as e:
